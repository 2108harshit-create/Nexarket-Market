...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    if (result.success) {
      toast.success("Account created! Welcome to NexArket!");
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-500 flex-col justify-between p-12 text-white">
        <div className="flex items-center gap-3">
          ...
          <span className="text-2xl font-bold">NexArket</span>
        </div>
        <div>
          ...
          <p className="text-lg text-white/80 mb-8">
            Whether you&apos;re looking to buy or sell, NexArket has everything you need.
          </p>
        ...
        <p className="text-white/60 text-sm">© 2026 NexArket. All rights reserved.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="text-xl font-bold text-gray-900">NexArket</span>
          </div>

          <h2 className="text-3xl font-bold text-gray-900 mb-2">Create account</h2>
          <p className="text-gray-500 mb-6">Join NexArket — it&apos;s free!</p>
