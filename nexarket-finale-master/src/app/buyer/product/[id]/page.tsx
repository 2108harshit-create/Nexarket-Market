      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { icon: Truck, title: "Free Shipping", desc: "On orders ₹4150+" },
      ...
      <div className="bg-white rounded-3xl overflow-hidden shadow-sm">
        ...
        <div className="p-6">
          ...
          {activeTab === "shipping" && (
            <div className="space-y-4">
              {[
                { icon: Truck, title: "Standard Delivery (3-7 days)", desc: "FREE on orders over ₹4150. ₹415 otherwise.", color: "bg-blue-50 text-blue-600" },
                { icon: Truck, title: "Express Delivery (1-2 days)", desc: "₹1080 flat rate.", color: "bg-purple-50 text-purple-600" },
